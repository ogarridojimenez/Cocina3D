...
- **009-multiusuario** — Edición colaborativa en tiempo real (WebSockets)
- **010-render-fotorrealista** — Render cloud fotorrealista con iluminación global
- **011-ia-sugerencias** — Sugerencias de distribución basadas en espacio y estilo
- **012-vr-ar** — Visor VR/AR con WebXR
- **013-presupuesto** — Generación de presupuesto desde los objetos colocados
